...
function sortRandomly2() {
    ...
    // Display the result
    displayResult(shuffledItems.slice(0, 1)); // Display the first two sorted items
}
...
function displayResult(sortedItems) {
    ...
    sortedItems.forEach((item) => {
        ...
        itemDiv.innerHTML = `
        <img id="photos" src="${photoUrl}" alt="${name}" height="355" width="365"><br><br><br>
        <style>
